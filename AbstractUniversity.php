...
abstract class AbstractUniversity
{
    ...
    protected $subjects = [];
    abstract public function controlSubject(string $code, string $name);
     ...
     * @return Subject
     */
    abstract public function addSubject(string $code, string $name);
     ...
     * @return int
     */
    abstract public function getNumberOfStudents();
